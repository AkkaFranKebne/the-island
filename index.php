...
<body id="main-page-body" <?php if ($_SESSION[ "seen_intro"]==0) { echo "class='loading'"; } ?>>
    <div id="menuOpacity"> </div>
    <?php include 'elements_nav_main.php';?>
    <main id="main-page-main" <?php if ($_SESSION[ "seen_intro"]==0) { echo "class='hidden'"; $_SESSION[ "seen_intro"]=1; }; if ($_SERVER[ 'REQUEST_METHOD']==='GET' ) { if (isset($_GET[ 'source'])===true) { $source=$ _GET[ 'source']; echo "data-source ='$source'"; } }; ?> >
